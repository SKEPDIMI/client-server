...
Game.preload = function(){
    ...
    this.load.image('tiles', assetsPath + '/tilesheet.png');
    this.load.spritesheet('phaserguy', 
        assetsPath + '/sprites.png',
        { frameWidth: 64, frameHeight: 96 }
    );
    // This master file contains information about your chunks; see splitter/splitmap.js how it is created
    this.load.json('master', assetsPath + '/map/chunks/master.json');
};
...
Game.updateEnvironment = function(){
    ...
    newChunks.forEach(function(c){
        ...
        Game.scene.load.tilemapTiledJSON('chunk'+c, assetsPath + '/map/chunks/chunk'+c+'.json');
    });
